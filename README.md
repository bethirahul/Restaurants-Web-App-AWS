...
Application link: [https://**rahulbethi**.com/**restaurants_catalogue**](https://rahulbethi.com/restaurants_catalogue)
...
Address to my hosted app: [https://**rahulbethi**.com/**restaurants_catalogue**](https://rahulbethi.com/restaurants_catalogue)
